...
/* harmony import */ var _order_orderlist_component__WEBPACK_IMPORTED_MODULE_43__ = __webpack_require__(/*! ./order/orderlist.component */ "./src/app/order/orderlist.component.ts");
...
var routes = [
    ...
    {
        path: 'orderlist',
        component: _order_orderlist_component__WEBPACK_IMPORTED_MODULE_43__["OrderlistComponent"]
    },
    {
        path: 'order/:id',
        component: _order_order_component__WEBPACK_IMPORTED_MODULE_42__["OrderComponent"]
...
/* harmony import */ var _order_order_component__WEBPACK_IMPORTED_MODULE_54__ = __webpack_require__(/*! ./order/order.component */ "./src/app/order/order.component.ts");
/* harmony import */ var _order_orderlist_component__WEBPACK_IMPORTED_MODULE_55__ = __webpack_require__(/*! ./order/orderlist.component */ "./src/app/order/orderlist.component.ts");
    ...
    AppModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["NgModule"])({
            declarations: [
                ...
                _order_order_component__WEBPACK_IMPORTED_MODULE_54__["OrderComponent"],
                _order_orderlist_component__WEBPACK_IMPORTED_MODULE_55__["OrderlistComponent"],
            ],
            imports: [
...
var BaseCtl = /** @class */ (function () {
    function BaseCtl(endpoint, serviceLocator, route) {
        ...
        this.serviceLocator.getPathVariable(route, function (params) {
            _this.form.data.id = params['id'];
            console.log('I GOT ID', _this.form.data.id);
        });
    }
    ...
    BaseCtl.prototype.preload = function () {
        var _this = this;
        this.serviceLocator.httpService.get(this.api.preload, function (res) {
            if (res.success) {
                _this.form.preload = res.result;
            }
            else {
    ...
    BaseCtl.prototype.search = function () {
        var _this = this;
        this.serviceLocator.httpService.post(this.api.search + "/" + this.form.pageNo, this.form.searchParams, function (res) {
            if (res.success) {
                _this.form.list = res.result.data;
                _this.nextList = res.result.nextList;
                if (_this.form.list.length === 0) {
                    _this.form.message = 'No record found';
                    _this.form.error = true;
                }
            }
            else {
    ...
    BaseCtl.prototype.display = function () {
        var _this = this;
        this.serviceLocator.httpService.get(this.api.get + "/" + this.form.data.id, function (res) {
            if (res.success) {
                _this.populateForm(_this.form.data, res.result.data);
            }
            else {
                _this.form.error = true;
                _this.form.message = res.result.message;
    ...
    BaseCtl.prototype.submit = function () {
        ...
        this.serviceLocator.httpService.post(this.api.save, this.form.data, function (res) {
            _this.form.message = '';
            _this.form.inputerror = {};
            if (res.success) {
                _this.form.message = 'Data is saved';
                _this.form.data.id = res.result.data.id;
            }
            else {
                _this.form.error = true;
                _this.form.message = res.result.message;
                if (res.result.inputerror) {
                    _this.form.inputerror = res.result.inputerror;
                }
            }
        });
    };
    BaseCtl.prototype.delete = function (id, callback) {
        var _this = this;
        this.serviceLocator.httpService.get(this.api.delete + "/" + id, function (res) {
            if (res.success) {
                _this.form.message = 'Data is deleted';
                if (callback) {
                    callback();
                }
            }
    ...
    BaseCtl.prototype.deleteMany = function (id, callback) {
        var _this = this;
        this.serviceLocator.httpService.post(this.api.deleteMany + "/" + id, this.form.data, function (res) {
            if (res.success) {
                _this.form.message = 'Data is deleted';
                if (callback) {
                    _this.form.list = res.result.data;
    ...
    BaseCtl.prototype.generateReport = function () {
        this.serviceLocator.httpService.get(this.api.report, function (res) {
            if (res.success) {
...
var LoginComponent = /** @class */ (function () {
    ...
    LoginComponent.prototype.ngOnInit = function () {
        ...
        this.serviceLocator.getPathVariable(this.route, function (params) {
            var logoutParam = params["userparams"];
...
var OrderComponent = /** @class */ (function (_super) {
    ...
    OrderComponent.prototype.onUpload = function (orderForm) {
        this.submit();
        console.log(this.form.data.id + '---- after submit');
    };
    OrderComponent.prototype.validate = function () {
        return this.validateForm(this.form.data);
    };
...
module.exports = ".alertRedColor {\r\n    color: red;\r\n}\r\n/*# sourceMappingURL=data:application/json;base64, */"
...
module.exports = ".alertRedColor {\r\n    color: red;\r\n}\r\n/*# sourceMappingURL=data:application/json;base64, */"
...
module.exports = __webpack_require__(/*! C:\Rays Software\Workspace\Project_10\Project_10\ORSProj10\ORSProject10-UI\src\main.ts */"./src/main.ts");
